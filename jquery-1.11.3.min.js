!(function (e, t) {
  ...
  (f.fn = f.prototype =
    ...
    f.extend({
      ...
      camelCase: function (e) {
        return e.replace(p, "ms-").replace(h, m);
      },
      ...
      map: function (e, t, n) {
        var r,
          ...
          a = e.length,
          s = [];
        if (g(e)) for (; o < a; o++) null != (r = t(e[o], o, n)) && s.push(r);
  ...
  var v = (function (e) {
    ...
    function oe(e, t, r, i) {
      var o, s, u, c, f, h, v, y, T, C;
      if (
        ((t ? t.ownerDocument || t : w) !== p && d(t),
        (t = t || p),
        (r = r || []),
        (c = t.nodeType),
    ...
    for (t in { submit: !0, reset: !0 })
      r.pseudos[t] =
        ...
        function (e) {
          var t = e.nodeName.toLowerCase();
          return ("input" === t || "button" === t) && e.type === he;
        });
    var he;
    function me() {}
    ...
    return (
      ...
      (l = oe.select =
        function (e, t, i, o) {
            ...
            for (
              ...
              if (
                ...
                (o = d(
                  ...
                  (ee.test(u[0].type) && de(t.parentNode)) || t
                ))
              ) {
          ...
          return (
            (p || s(e, h))(o, t, !m, i, (ee.test(e) && de(t.parentNode)) || t),
            i
          );
        }),
  ...
  var y = f.expr.match.needsContext,
    b = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
    x = /^.[^:#\[\.,]*$/;
  function w(e, t, n) {
    if (f.isFunction(t))
    ...
    if ("string" == typeof t) {
      if (x.test(t)) return f.filter(t, e, n);
      t = f.filter(t, e);
    }
    return f.grep(e, function (e) {
    ...
    f.fn.extend({
      find: function (e) {
        ...
        if ("string" != typeof e)
          return this.pushStack(
            f(e).filter(function () {
              for (t = 0; t < i; t++) if (f.contains(r[t], this)) return !0;
            })
          );
        for (t = 0; t < i; t++) f.find(e, r[t], n);
        return (
      ...
      is: function (e) {
        return !!w(this, "string" == typeof e && y.test(e) ? f(e) : e || [], !1)
          .length;
      },
    });
  var T,
    ...
    if ("string" == typeof e) {
      ...
      if (n[1]) {
        if (
          ...
          f.merge(
            this,
            f.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : C, !0)
          ),
          b.test(n[1]) && f.isPlainObject(t))
        )
          for (n in t)
    ...
    f.fn.extend({
      has: function (e) {
        ...
        return this.filter(function () {
          for (t = 0; t < r; t++) if (f.contains(this, n[t])) return !0;
        });
      },
      closest: function (e, t) {
        for (
          var n,
            ...
            i = this.length,
            o = [],
            a = y.test(e) || "string" != typeof e ? f(e, t || this.context) : 0;
          r < i;
          r++
        )
    ...
    function (e, t) {
      f.fn[e] = function (n, r) {
        ...
        return (
          ...
          this.length > 1 &&
            (k[e] || (i = f.unique(i)), E.test(e) && (i = i.reverse())),
          this.pushStack(i)
        );
      };
    }
  ...
  (f.Callbacks = function (e) {
    var t,
      ...
      u = function (f) {
        for (
          n = e.memory && f, r = !0, o = a || 0, a = 0, i = s.length, t = !0;
          s && o < i;
          o++
        )
        ...
        if (!0 === e ? !--f.readyWait : !f.isReady) {
          ...
          (f.isReady = !0),
            (!0 !== e && --f.readyWait > 0) ||
              (j.resolveWith(C, [f]),
              f.fn.triggerHandler &&
                (f(C).triggerHandler("ready"), f(C).off("ready")));
        }
      },
    });
  function L() {
    C.addEventListener
      ? (C.removeEventListener("DOMContentLoaded", H, !1),
        e.removeEventListener("load", H, !1))
      : (C.detachEvent("onreadystatechange", H), e.detachEvent("onload", H));
  }
  function H() {
    (C.addEventListener ||
      "load" === event.type ||
  ...
  f.ready.promise = function (t) {
    if (!j)
      if (((j = f.Deferred()), "complete" === C.readyState))
        setTimeout(f.ready);
      else if (C.addEventListener)
        C.addEventListener("DOMContentLoaded", H, !1),
          e.addEventListener("load", H, !1);
      else {
        C.attachEvent("onreadystatechange", H), e.attachEvent("onload", H);
        var n = !1;
        try {
      ...
      if (a[s]) {
        if (t && (r = n ? a[s] : a[s].data)) {
          i = (t = f.isArray(t)
            ...
            : t in r
            ? [t]
            : (t = f.camelCase(t)) in r
            ? [t]
            : t.split(" ")).length;
          for (; i--; ) delete r[t[i]];
          if (n ? !B(r) : !f.isEmptyObject(r)) return;
        }
  ...
  f.extend({
    ...
    hasData: function (e) {
      return !!(e = e.nodeType ? f.cache[e[f.expando]] : e[f.expando]) && !B(e);
    },
    data: function (e, t, n) {
      return P(e, t, n);
    },
          ...
          if (
            ...
            for (n = a.length; n--; )
              a[n] &&
                ...
                O(o, (r = f.camelCase(r.slice(5))), i[r]);
  ...
  var W = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    I = (f.access = function (e, t, n, r, i, o, a) {
      var s = 0,
        l = e.length,
        u = null == n;
      if ("object" === f.type(n)) {
  ...
  (f.event = {
        ...
        for (
          n.handler && ((n = (l = n).handler), (i = l.selector)),
            ...
            (c = v.handle) ||
              ((c = v.handle =
                function (e) {
                  return typeof f === _ || (e && f.event.triggered === e.type)
                    ? void 0
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !c.noBubble && !f.isWindow(r)) {
          for (
            l = c.delegateType || m, Y.test(l + m) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            h.push(s), (d = s);
    ...
    fix: function (e) {
      ...
      for (
        a ||
          (this.fixHooks[i] = a =
            J.test(i) ? this.mouseHooks : V.test(i) ? this.keyHooks : {}),
    ...
    mouseHooks: {
      ...
      filter: function (e, t) {
        ...
        return (
          null == e.pageX &&
            null != t.clientX &&
            ((i = (r = e.target.ownerDocument || C).documentElement),
            (n = r.body),
            (e.pageX =
              t.clientX +
    ...
    (f.removeEvent = C.removeEventListener
      ...
      : function (e, t, n) {
          var r = "on" + t;
          e.detachEvent &&
            (typeof e[r] === _ && (e[r] = null), e.detachEvent(r, n));
        }),
  ...
  function ge(e, t) {
    var n,
      ...
      i = 0,
      o =
        typeof e.getElementsByTagName !== _
          ? e.getElementsByTagName(t || "*")
          : typeof e.querySelectorAll !== _
          ? e.querySelectorAll(t || "*")
          : void 0;
    if (!o)
      for (o = [], n = e.childNodes || e; null != (r = n[i]); i++)
        !t || f.nodeName(r, t) ? o.push(r) : f.merge(o, ge(r, t));
  ...
  function Te(e, t) {
    if (1 === t.nodeType && f.hasData(e)) {
      ...
      if (s) {
        ...
        for (n in s)
          for (r = 0, i = s[n].length; r < i; r++) f.event.add(t, n, s[n][r]);
      }
  ...
  f.extend({
    clone: function (e, t, n) {
      ...
      if (
        (c.html5Clone || f.isXMLDoc(e) || !re.test("<" + e.nodeName + ">")
          ? (o = e.cloneNode(!0))
        ...
        for (r = ge(o), s = ge(e), a = 0; null != (i = s[a]); ++a)
          r[a] && Ce(i, r[a]);
      if (t)
        if (n)
          for (s = s || ge(e), r = r || ge(o), a = 0; null != (i = s[a]); a++)
            Te(i, r[a]);
        else Te(e, o);
      return (
        (r = ge(o, "script")).length > 0 && we(r, !l && ge(e, "script")),
        (r = s = i = null),
        o
      );
    },
    buildFragment: function (e, t, n, r) {
      for (
        var i, o, a, s, l, u, d, p = e.length, h = ee(t), m = [], g = 0;
        g < p;
        g++
      )
        if ((o = e[g]) || 0 === o)
          if ("object" === f.type(o)) f.merge(m, o.nodeType ? [o] : o);
            ...
            for (
              s = s || h.appendChild(t.createElement("div")),
                ...
                d = he[l] || he._default,
                s.innerHTML = d[1] + o.replace(oe, "<$1></$2>") + d[2],
                i = d[0];
              i--;
            ...
            if (
              (!c.leadingWhitespace &&
                ie.test(o) &&
                m.push(t.createTextNode(ie.exec(o)[0])),
              !c.tbody)
            )
              for (
                i =
      ...
      for (
        s && h.removeChild(s),
          c.appendChecked || f.grep(ge(m, "input"), ve),
          g = 0;
        (o = m[g++]);
    ...
    f.fn.extend({
      ...
      remove: function (e, t) {
        for (
          ...
          t || 1 !== n.nodeType || f.cleanData(ge(n)),
            n.parentNode &&
              (t && f.contains(n.ownerDocument, n) && we(ge(n, "script")),
              n.parentNode.removeChild(n));
        return this;
      },
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++) {
          for (1 === e.nodeType && f.cleanData(ge(e, !1)); e.firstChild; )
        ...
        return I(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !ue.test(e) &&
              (c.htmlSerialize || !re.test(e)) &&
              (c.leadingWhitespace || !ie.test(e)) &&
              ...
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (f.cleanData(ge(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      domManip: function (e, t) {
        ...
        var n,
          ...
          m = e[0],
          g = f.isFunction(m);
        if (g || (d > 1 && "string" == typeof m && !c.checkClone && ce.test(m)))
        ...
        if (
          ...
          for (o = (a = f.map(ge(l, "script"), be)).length; u < d; u++)
            (r = l),
              u !== h &&
                ((r = f.clone(r, !0, !0)), o && f.merge(a, ge(r, "script"))),
              t.call(this[u], r, u);
          if (o)
            for (
              s = a[a.length - 1].ownerDocument, f.map(a, xe), u = 0;
              u < o;
              u++
            )
              (r = a[u]),
    ...
    f.each(
      ...
      function (e, t) {
        f.fn[e] = function (e) {
          for (var n, r = 0, i = [], a = f(e), s = a.length - 1; r <= s; r++)
  ...
  !(function () {
    ...
    c.shrinkWrapBlocks = function () {
      ...
      e = !1;
      var t, n, r;
      return (n = C.getElementsByTagName("body")[0]) && n.style
        ? ((t = C.createElement("div")),
          ((r = C.createElement("div")).style.cssText =
            "position:absolute;border:0;width:0;height:0;top:0;left:-9999px"),
          n.appendChild(r).appendChild(t),
    ...
    function l() {
      ...
      (n = C.getElementsByTagName("body")[0]) &&
        ...
        e.getComputedStyle &&
          ...
          (o =
            "4px" === (e.getComputedStyle(t, null) || { width: "4px" }).width),
          ((l = t.appendChild(C.createElement("div"))).style.cssText =
            t.style.cssText =
  ...
  function $e(e, t) {
    if (t in e) return t;
    for (
      var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = We.length;
      i--;
      ...
      (r = e[a]).style &&
        ...
        t
          ? (o[a] || "none" !== n || (r.style.display = ""),
            "" === r.style.display &&
              z(r) &&
              (o[a] = f._data(r, "olddisplay", Se(r.nodeName))))
          : ((i = z(r)),
            ((n && "none" !== n) || !i) &&
  ...
  function Xe(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (a += f.css(e, n + $[o], !0, i)),
        r
          ? ("content" === n && (a -= f.css(e, "padding" + $[o], !0, i)),
            "margin" !== n && (a -= f.css(e, "border" + $[o] + "Width", !0, i)))
          : ((a += f.css(e, "padding" + $[o], !0, i)),
            "padding" !== n &&
              (a += f.css(e, "border" + $[o] + "Width", !0, i)));
    return a;
  }
  function Ue(e, t, n) {
    var r = !0,
    ...
    if (i <= 0 || null == i) {
      if (
        (((i = De(e, t, o)) < 0 || null == i) && (i = e.style[t]), Le.test(i))
      )
        return i;
  ...
  f.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          ((t = f.cssProps[s] || (f.cssProps[s] = $e(l, s))),
    ...
    css: function (e, t, n, r) {
      var i,
        ...
        s = f.camelCase(t);
      return (
        (t = f.cssProps[s] || (f.cssProps[s] = $e(e.style, s))),
        (a = f.cssHooks[t] || f.cssHooks[s]) &&
          "get" in a &&
          (o = a.get(e, !0, n)),
        void 0 === o && (o = De(e, t, r)),
    ...
    f.each(["height", "width"], function (e, t) {
      f.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return Fe.test(f.css(e, "display")) && 0 === e.offsetWidth
              ? f.swap(e, Pe, function () {
                  return Ue(e, t, r);
                })
              : Ue(e, t, r);
        },
    ...
    (f.cssHooks.marginRight = qe(c.reliableMarginRight, function (e, t) {
      if (t)
        return f.swap(e, { display: "inline-block" }, De, [e, "marginRight"]);
    })),
    f.each({ margin: "", padding: "", border: "Width" }, function (e, t) {
      (f.cssHooks[e + t] = {
        ...
        je.test(e) || (f.cssHooks[e + t].set = Ie);
    }),
    f.fn.extend({
      css: function (e, t) {
        return I(
    ...
    Ze = [
      function (e, t, n) {
        ...
        1 === e.nodeType &&
          ...
          (u = f.css(e, "display")),
          "inline" ===
            ("none" === u ? f._data(e, "olddisplay") || Se(e.nodeName) : u) &&
            "none" === f.css(e, "float") &&
            (c.inlineBlockNeedsLayout && "inline" !== Se(e.nodeName)
              ? (h.zoom = 1)
        ...
        if (f.isEmptyObject(p))
          "inline" === ("none" === u ? Se(e.nodeName) : u) && (h.display = u);
        else {
          g ? "hidden" in g && (m = g.hidden) : (g = f._data(e, "fxshow", {})),
            o && (g.hidden = !m),
            m
              ? f(e).show()
              : d.done(function () {
  ...
  function rt(e, t, n) {
    for (
      var r, i = (et[t] || []).concat(et["*"]), o = 0, a = i.length;
      o < a;
      o++
    )
  ...
  function it(e, t, n) {
    ...
    for (
      ...
      if ((r = Ze[o].call(u, e, c, u.opts))) return r;
    return (
      f.map(c, rt, u),
  ...
  (f.Animation = f.extend(it, {
      ...
      stop: function (e, t, n) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (i in a) a[i] && a[i].stop && Ke.test(i) && r(a[i]);
            for (i = o.length; i--; )
              o[i].elem !== this ||
                (null != e && o[i].queue !== e) ||
    ...
    (function () {
      var e, t, n, r, i;
      (t = C.createElement("div")).setAttribute("className", "t"),
        (t.innerHTML =
          "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
        (r = t.getElementsByTagName("a")[0]),
        (i = (n = C.createElement("select")).appendChild(
        ...
        (c.enctype = !!C.createElement("form").enctype),
        (n.disabled = !0),
        (c.optDisabled = !i.disabled),
        (e = C.createElement("input")).setAttribute("value", ""),
  ...
  f.fn.extend({
    val: function (e) {
        ...
        i = this[0];
      {
        ...
        if (i)
          return (t =
            f.valHooks[i.type] || f.valHooks[i.nodeName.toLowerCase()]) &&
            "get" in t &&
  ...
  var at,
    st,
    lt = f.expr.attrHandle,
    ut = /^(?:checked|selected)$/i,
    ct = c.getSetAttribute,
    ft = c.input;
  f.fn.extend({
    attr: function (e, t) {
      return I(this, f.attr, e, t, arguments.length > 1);
    },
      ...
      attr: function (e, t, n) {
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute === _
            ...
            : ((1 === o && f.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (r = f.attrHooks[t] || (f.expr.match.bool.test(t) ? st : at))),
              void 0 === n
      ...
      set: function (e, t, n) {
        return (
          !1 === t
            ? f.removeAttr(e, n)
            : (ft && ct) || !ut.test(n)
            ? e.setAttribute((!ct && f.propFix[n]) || n, n)
    ...
    (ft && ct) ||
      (f.attrHooks.value = {
        set: function (e, t, n) {
          if (!f.nodeName(e, "input")) return at && at.set(e, t, n);
          e.defaultValue = t;
        },
      }),
    ct ||
  ...
  f.fn.extend({
    prop: function (e, t) {
      return I(this, f.prop, e, t, arguments.length > 1);
    },
  ...
  f.fn.extend({
    addClass: function (e) {
      ...
      if (u)
        for (t = (e || "").match(A) || []; s < l; s++)
          if (
            (r =
              1 === (n = this[s]).nodeType &&
              (n.className ? (" " + n.className + " ").replace(ht, " ") : " "))
          ) {
            for (o = 0; (i = t[o++]); )
              r.indexOf(" " + i + " ") < 0 && (r += i + " ");
    ...
    toggleClass: function (e, t) {
      ...
      return "boolean" == typeof t && "string" === n
        ...
        : this.each(function () {
            if ("string" === n)
              for (
                var t, r = 0, i = f(this), o = e.match(A) || [];
                (t = o[r++]);
  ...
  f.extend({
    ...
    ajaxSetup: function (e, t) {
      return t ? Lt(Lt(e, f.ajaxSettings), t) : Lt(f.ajaxSettings, e);
    },
    ajaxPrefilter: Dt(kt),
    ajaxTransport: Dt(St),
    ajax: function (e, t) {
      ...
      var n,
        ...
        w = {
          ...
          getResponseHeader: function (e) {
            ...
            if (2 === b) {
              if (!u)
                for (u = {}; (t = Tt.exec(o)); ) u[t[1].toLowerCase()] = t[2];
              t = u[e.toLowerCase()];
            }
      ...
      (s = f.event && c.global) &&
        ...
        c.hasContent ||
          (c.data &&
            ((i = c.url += (gt.test(i) ? "&" : "?") + c.data), delete c.data),
          !1 === c.cache &&
            (c.url = wt.test(i)
              ? i.replace(wt, "$1_=" + mt++)
              : i + (gt.test(i) ? "&" : "?") + "_=" + mt++)),
  ...
  e.attachEvent &&
    ...
    (c.cors = !!Rt && "withCredentials" in Rt),
    (Rt = c.ajax = !!Rt) &&
  ...
  f.ajaxSetup({
    ...
    f.ajaxTransport("script", function (e) {
      if (e.crossDomain) {
        var t,
          n = C.head || f("head")[0] || C.documentElement;
        return {
          send: function (r, i) {
            ((t = C.createElement("script")).async = !0),
  ...
  (f.offset = {
      ...
      offset: function (e) {
        ...
        if (o)
          return (
            (t = o.documentElement),
            f.contains(t, i)
              ? (typeof i.getBoundingClientRect !== _ &&
    ...
    f.each(["top", "left"], function (e, t) {
      f.cssHooks[t] = qe(c.pixelPosition, function (e, n) {
        if (n)
          return (n = De(e, t)), Le.test(n) ? f(e).position()[t] + "px" : n;
      });
    }),
  ...
  return (
    (f.noConflict = function (t) {
      return e.$ === f && (e.$ = Jt), t && e.jQuery === f && (e.jQuery = Vt), f;
    }),
    typeof t === _ && (e.jQuery = e.$ = f),
    f
  );
});
